...
from proxy_management.users.schemas import HashType
...
class EngineSingleton:
    ...
    def get_instance(cls) -> Engine:
        ...
        if cls._instance is None:
            from proxy_management.db_connection import engine  # pylint: disable=import-outside-toplevel
...
def get_proxy_credentials_from_db(users_emails: list[str]) -> Sequence[Row[tuple[str, str, str]]]:
    ...
    from proxy_management.modems.models import Modem  # noqa F401
